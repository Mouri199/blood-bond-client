    ...
    const handleLogin = e => {
        ...
        loginUser(email, password)
            .then(result => {
                ...
                e.target.reset()
                registerNavi(from, { replace: true });
                Swal.fire({
                    icon: "success",
                    ...
                    <div className="card w-full max-w-sm ">
                        <form onSubmit={handleLogin} className="">
                            ...
                            <div className="form-control">
                                ...
                                <input onBlur={handleCaptcha} type="password" name='captcha' placeholder="type the captcha" className="input input-bordered lg:w-[400px]" required />


                            </div>
                            <div>
                                <p className='text-center'>
                                    New Here? Please <Link to='/register'> <span className='hover:text-redclr'>Register</span></Link>
                                </p>
                            </div>
                            <div className="form-control mt-6">

                                <input type="submit" disabled={disable} value="Login" className="btn text-white btn-outline bg-redclr hover:bg-hoverclr lg:w-[400px]" />
                            </div>
