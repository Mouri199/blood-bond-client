                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="lg:flex gap-10 ">
                        <div className="form-control lg:w-full">
                            ...
                            <label>
                                <input type="text" name="photo" {...register("recipientname")} placeholder="Recipient Name" className="input input-bordered lg:w-full" />
                        ...
                        <div className="form-control lg:w-full">
                            ...
                            <select className="select md:w-[480px] lg:w-[715px] h-[10px] select-bordered " {...register("bloodgroup")}>
                    ...
                    <div className="lg:flex gap-10">
                        <div className="form-control md:w-1/2">
                            ...
                            <label>
                                ...
                                <input type="text" readOnly defaultValue={user?.displayName} name="name" {...register("requestername")} placeholder="Requester Name" className="input  input-bordered w-full" />
                        ...
                        <div className="form-control md:w-1/2">
                            ...
                            <label>
                                <input type="text" readOnly defaultValue={user?.email} name="chef" {...register("email")} placeholder="Requester Email" className="input input-bordered w-full" />
                    ...
                    <div className="form-control md:w-1/2">
                        ...
                        <label>
                            <input type="text" readOnly name="details" {...register("status")} placeholder="Status"  className="input input-bordered w-full" />
