...
const Blogs = ({ blogs }) => {
    const { _id,name, short,img } = blogs || {}
    return (
        <div>
            <div className="lg:w-[600px] lg:mx-0 mx-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                ...
                <div className="p-5">
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{short}</p>
