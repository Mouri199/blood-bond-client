...
const Footer = () => {
    return (
        <footer className="bg-background lg:w-full">
            <div className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">

                <div className="lg:flex items-center justify-between lg:mx-0 gap-6">
                    <div>
                        <img className="w-[300px] lg:mx-0 mx-10  flex justify-center" src={img} alt="" />

                    </div>

                    <div className="flex lg:gap-28 justify-between">
                        <div>
                    ...
                    <div className="col-span-2">
                        ...
                        <form>
                            ...
                            <p className="mt-3 text-sm flex lg:justify-start justify-center text-black">
                ...
                <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
                    <div className="flex lg:justify-between justify-center items-center">
                        <p className="text-sm text-black">© 2022 Preline. All rights reserved.</p>
                    </div>


                    <div className="flex justify-center">
                        <a className="w-10 h-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-black hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600" href="#">
